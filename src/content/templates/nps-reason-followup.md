...
steps:
  ...
  - title: "Run it as a pulse"
    desc: "Send it monthly, quarterly, or after a big release. Thirty seconds per respondent."
  - title: "Act on the segments"
    desc: "Fix what detractors flag, win over passives, and publish the testimonials promoters cleared. Compute the headline NPS from the exported scores."
faq:
  - q: "What is NPS?"
