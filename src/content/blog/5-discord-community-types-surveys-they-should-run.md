---
title: "Discord Community Types and the Surveys, Polls, and Forms They Should Run"
description: "Gaming guilds, game studios, creators, brands, DAOs, and study servers all run on Discord and all need different things from their members. A short map of what each should be asking, running, and collecting."
pubDate: "Feb 18 2026"
updatedDate: "Aug 13 2026"
author: "Subo Team"
tags: ["community types", "use cases", "discord", "survey ideas", "gaming", "creator", "dao"]
faq:
  - q: "What kind of surveys should a Discord gaming guild run?"
    a: "Pre-season role and availability surveys before a major patch, post-raid debriefs while impressions are fresh, and scheduling polls instead of guessing at raid times. Officer elections work better as an anonymous survey than as a public Discord poll."
  - q: "How do game studios use Discord for player feedback?"
    a: "Three jobs, usually: recruiting playtesters from the server, collecting structured build feedback and bug reports instead of a #bugs channel nobody triages, and letting players vote on roadmap priorities. Discord reaches the players who care most about the game, which is the population worth asking."
  - q: "Can I collect feedback from people who are not in my Discord server?"
    a: "Yes. A Subo survey can be opened as a web link that anyone can answer without a Discord account, which is how studios and brands reach players and customers beyond the server."
  - q: "What should a brand or product community be asking?"
    a: "Product feedback and feature prioritization from your most engaged customers, NPS with a follow-up that asks why the score is what it is, and churn interviews with people who are leaving. These are the ones with direct revenue value."
draft: false
---

Discord hosts wildly different communities, and the survey advice written for one of them is usually wrong for the rest. A raid guild and a game studio and a study server all need feedback, but they need it about different things, on different rhythms, with different consequences when they get it wrong.
...
## Gaming guilds and competitive teams
...
If you need reach beyond the server, any Subo survey can be opened as a web link that works without a Discord account.

---

## Creators: streamers, YouTubers, podcasters
...
## Brands and product communities
...
Governance votes happen on-chain. The discussion that decides them happens in Discord, and token-weighted voting is bad at surfacing what quiet holders think.
...
## Study groups and course cohorts
