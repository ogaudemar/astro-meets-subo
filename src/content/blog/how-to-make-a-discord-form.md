...
- **Nobody leaves the server.** Members answer in a DM with the bot, or in a private thread if their DMs are closed, right where they already are. No new tab, no context switch.
